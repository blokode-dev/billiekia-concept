...
const securityHeaders = [
  ...
  // Content Security Policy — autorise uniquement nos ressources
  {
    ...
    value: [
      ...
      "connect-src 'self' https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://www.googleapis.com https://firestore.googleapis.com https://firebase.googleapis.com",
      "frame-src https://accounts.google.com https://billiekia-concept.firebaseapp.com",
